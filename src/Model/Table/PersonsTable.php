...
class PersonsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('bloodgroup')
            ->maxLength('bloodgroup', 100)
            ->requirePresence('bloodgroup', 'create')
            ->notEmptyString('bloodgroup');
        ...
        $validator
            ->scalar('skillset')
            ->maxLength('skillset', 100)
            ->requirePresence('skillset', 'create')
            ->notEmptyString('skillset');
